...
client.on('ready', () => {
  ...
  setInterval(() => {
    let status = [
      ...
      {
        name: `recording reels with wonho...`,
        type: Discord.ActivityType.Watching,
      },
    ]; // AQUI AGREGAS LOS ESTADOS || "Playing", "Watching", "Listening", "Streaming", "Custom"
    let random = Math.floor(Math.random() * status.length); // MANDA DE MANERA ALEATORIA
